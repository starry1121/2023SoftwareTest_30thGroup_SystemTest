<template>
    ...
    <div class="bg">
        ...
        <el-col :span="3" :offset="3">
            ...
            default-active="/jobhunter/person"
            router=true
            ...
            <el-col :span="14">
                ...
                >
                    <el-form-item label="UID">
                        <el-input v-model="jobhunterId" disabled/>
                    </el-form-item>
...
import 'element-plus/es/components/message/style/index'
    ...
    return {
        ...
        userInfo:{
            ...
            birthday:"1976-02-20",
            school:"laborum officia reprehenderit"
        },
        // userInfoEdit:{
        //     jobhunterId:null,
        //     nickname:null,
    ...
    methods: {
        ...
        cancelEdit(){
            ...
            this.userInfo.birthday=this.userInfoEdit.birthday
            this.userInfo.school=this.userInfoEdit.school
        ...
        onSubmit(){
            ...
            this.userInfoEdit.birthday=this.userInfo.birthday,
            this.userInfoEdit.school=this.userInfo.school
            this.$axios({
                method: 'put',
                url: '/api/Jobhunter/personInfo/set',
    ...
    created() {
        ...
        .then(res => {
            ...
            this.userInfo=res.data.data.person_list;
            console.log(this.userInfo);
            this.userInfoEdit.jobhunterId=localStorage.getItem('userId'),
            this.userInfoEdit.nickname=this.userInfo.nickname,
